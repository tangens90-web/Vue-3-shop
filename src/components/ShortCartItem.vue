...
<modal-form @mouseover  = "setCursorOverModal(true)"
        ...
        <div> <h2>Buy products: {{products.length }}</h2></div>
  ...
  <path d="M2.146 2.854a.5.5 0 1 1 .708-.708L8 7.293l5.146-5.147a.5.5 0 0 1 .708.708L8.707 8l5.147 5.146a.5.5 0 0 1-.708.708L8 8.707l-5.146 5.147a.5.5 0 0 1-.708-.708L7.293 8 2.146 2.854Z"/>
    ...
    <hr>
        <div class="d-flex justify-content-between"><div>Total price:</div> <div>{{price}} руб</div></div>
...
import { useProducts } from '../store/modules/product' 
    ...
    const storePinia = useProducts()     
        ...
        const products = computed(()=>{return storePinia.cart})
    ...
    const price = computed(()=>{return storePinia.price})
