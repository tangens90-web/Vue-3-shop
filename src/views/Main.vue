<template>
  ...
  <div class="container-custom mt-3" :class="{ container_margin: headerFixed }">
    <div class="toggle_view">
      <button class="gorizontal_view btn_view" @click="gorizontalView = true">
        <svg
      ...
      <button class="vertical_view btn_view" @click="gorizontalView = false">
        <svg
          xmlns="http://www.w3.org/2000/svg"
          width="25"
          height="25"
