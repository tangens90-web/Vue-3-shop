<template>
  ...
  <div class="container">
    ...
    >
      <div
        class="vertical_card mb-3 scaleCard"
          ...
          <div class="image-block">
            <div class="carousel_images">
              <div
                ...
                v-for="(imageUrl, index) in product.img"
                :class="{ active: index == 0 }"
                :ref="(el) => (carouselImages[index] = el)"
              >
                <img
                  @mouseenter="
                    changeMainImage(imageUrl, index, product.img.length)
                  "
...
const products = computed(() => {
  return storePinia.products.filter(
